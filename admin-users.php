...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $role = $_POST['role'];
    $is_active = isset($_POST['is_active']) ? 1 : 0; // Permission handling
    ...
    try {
        ...
        if ($e->getCode() == 1062) { // Duplicate entry
            $message = "Error: Email address '$email' is already registered.";
        } else {
...
<body>
    ...
    <div class="sidebar d-flex flex-column">
        ...
        <nav class="nav flex-column mt-4">
            ...
            <a class="nav-link active" href="admin-users.php"><i class="bi bi-people"></i> User Management</a>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><span
                                    class="badge <?php echo $row['role'] == 'admin' ? 'bg-danger' : 'bg-info'; ?>"><?php echo ucfirst($row['role']); ?></span>
                            </td>
                            <td>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label">Grant Permission (Active)</label>
                        </div>
                    </div>
